...
phina.define('Stage4', {
  ...
  init: function() {
    ...
    localStorage.setItem('Stage4FLG',true);

    this.fromJSON({
      children: {
        bg: {
          className: 'Sprite',
          arguments: 'stage4back',
          originX: 0,
          originY: 0,
        },
        backGroup: {
    ...
    this.player = Player4().addChildTo(this);
    ...
    var block1 = Block4(0,800).addChildTo(this.blockGroup);
    var bwidth = block1.width - 7;
    var block2 = Block4(bwidth,800).addChildTo(this.blockGroup);
    var block3 = Block4(bwidth*2,800).addChildTo(this.blockGroup);
    var block4 = Block4(bwidth*3,800).addChildTo(this.blockGroup);
    var block5 = Block4(bwidth*4,800).addChildTo(this.blockGroup);
    var block6 = Block4(bwidth*5,800).addChildTo(this.blockGroup);
    var block7 = Block4(bwidth*6,800).addChildTo(this.blockGroup);
  ...
  update: function(app) {
    ...
    if (app.frame % 40 === 0) {
      ...
      var block = Block4(x,ry).addChildTo(this.blockGroup);
    }
...
phina.define("Block4", {
  ...
  init: function(x,y) {
      ...
      this.sprite = Sprite('block4').addChildTo(this);
