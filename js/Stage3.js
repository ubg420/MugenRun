...
phina.define('Stage3', {
  ...
  init: function() {
    ...
    this.player = Player3().addChildTo(this);
    ...
    var block1 = Block3(0,800).addChildTo(this.blockGroup);
    var bwidth = block1.width - 7;
    var block2 = Block3(bwidth,800).addChildTo(this.blockGroup);
    var block3 = Block3(bwidth*2,800).addChildTo(this.blockGroup);
    var block4 = Block3(bwidth*3,800).addChildTo(this.blockGroup);
    var block5 = Block3(bwidth*4,800).addChildTo(this.blockGroup);
    var block6 = Block3(bwidth*5,800).addChildTo(this.blockGroup);
    var block7 = Block3(bwidth*6,800).addChildTo(this.blockGroup);
  ...
  update: function(app) {
    ...
    if (app.frame % 40 === 0) {
      ...
      var block = Block3(x,ry).addChildTo(this.blockGroup);
    }
...
phina.define("Block3", {
  ...
  init: function(x,y) {
      ...
      this.sprite = Sprite('block3').addChildTo(this);
